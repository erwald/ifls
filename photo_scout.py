...
with smart_run(session):
    ...
    while (download_count + len(existing_users)) < 5:
        ...
        if num_followers > 1000 or num_followers < 20:
            ...
            shell_cmd = f"instagram-scraper --media-types=image --profile-metadata --include-location --comments --retry-forever --destination=library --retain-username {random_follower}"
            os.system(shell_cmd)
